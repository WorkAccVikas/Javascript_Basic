function hello() {
  ...
  function innerFunc() {
    ...
    console.log("In innerFunc = ", this.name); // ? : undefined
...
const hello1 = () => {
  ...
  function innerFunc1() {
    ...
    console.log("In innerFunc1 = ", this.name); // ? : undefined
    console.log("In innerFunc1 = ", name); // ? : pooja
  }
  innerFunc1();

  const innerFunc2 = () => {
    console.log("In innerFunc2 = ", this); // * : {} because arrow function call
    console.log("In innerFunc2 = ", this.name); // ? : undefined
